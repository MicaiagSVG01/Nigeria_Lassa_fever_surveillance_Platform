...
The current Streamlit application represents the MVP.

Future development is planned in several stages.

## Multi-Disease Surveillance

Additional NCDC surveillance datasets may include:
...
* Meningitis
* Yellow fever
* other diseases where sufficiently structured public data is available

The Disease filter has already been included in the application architecture to support this expansion.

---

# Geographic Visualisation

A future version will include an interactive map of Nigeria showing disease burden by state.

Potential geographic metrics include:
...
A planned analytics component will investigate unusual changes in disease activity.
...
These tools would be presented as surveillance indicators rather than diagnostic predictions.

---

# Historical Analysis

The platform may later incorporate several years of surveillance data.

This could allow comparison of:
...
and help identify seasonal and unusual disease patterns.

---

# Advanced Web Application

The Streamlit version is intended as a proof-of-concept MVP.

A later production-oriented version is planned using technologies such as:
...
The objective is to transform the validated MVP into a more scalable web-based surveillance platform.
